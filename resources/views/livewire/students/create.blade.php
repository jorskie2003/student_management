<div class="py-12 bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <!-- Container with background color for better contrast -->
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex flex-col gap-y-4 mb-8">
                    <div class="flex flex-col gap-y-1">
                        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Student Information</h1>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Fill out this form to create a new student record. Please ensure all details are accurate.</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                class="block w-full px-4 py-3 text-sm rounded-lg border-gray-300 pe-9 focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-teal-600
